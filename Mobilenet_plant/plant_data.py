plant_inf={
    ...
    '萼距花':'萼距花（学名：Cuphea hookeriana Walp.）是千屈菜科、萼距花属植物。灌木或亚灌木状，高30-70厘米，直立，粗糙，被粗毛及短小硬毛，分枝细，密被短柔毛。叶薄革质，顶端长渐尖，基部圆形至阔楔形，下延至叶柄，幼时两面被贴伏短粗毛，后渐脱落而粗糙。花瓣6，其中上方2枚特大而显著，矩圆形，深紫色，波状，具爪，其余4枚极小，锥形，有时消失；子房矩圆形。原产墨西哥；中国北京等地有引种',
    '蒲儿根':'蒲儿根（学名：inosenecio oldhamianus (Maxim.) B. Nord.）是菊科蒲儿根属植物。',
    '月季花':'月季花（Rosa chinensis Jacq.）是蔷薇科属的常绿、半常绿低矮灌木。叶子为羽状复叶，表面深绿有光泽而叶背青白，且无毛面具有小托叶。花分单瓣和重瓣，重瓣色为深红且略似玫瑰。花色以红色为主，其他有白、黄、粉红、玫瑰红等。蔷薇果卵圆形或梨形，熟时红色。自然花期4月-9月。 [18]月季花，以一年四季不分春、夏、秋、冬皆能见花而得名，又以其每月近乎开花一次而得名“月月红”“长春花”',
    '朱顶红':'朱顶红（Hippeastrum striatum (Lam.) H. E. Moore），石蒜科属多年生草本植物， [10]鳞茎近球形，并有匍匐枝；叶鲜绿色，带形；花茎中空，稍扁，具有白粉，圆筒状，花被裂片长圆形，顶端尖，红色，略带紫色；花丝红色，花药线状长圆形；蒴果球形；花期夏季。'
}